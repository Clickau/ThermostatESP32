...
const char updateErrorAuth[] PROGMEM = "Auth Error";
const char updateErrorBegin[] PROGMEM = "Begin Error";
const char updateErrorConnect[] PROGMEM = "Connect Error";
const char updateErrorReceive[] PROGMEM = "Receive Error";
const char updateErrorEnd[] PROGMEM = "End Error";
const char updateWaiting[] PROGMEM = "Waiting for\nupdate";
const char updateProgress[] PROGMEM = "Progress: %u%%\n";
